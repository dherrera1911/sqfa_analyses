...
sqfa_fisher_rao_path = artifact_path(
    RESULTS_DIR,
    "sqfa",
    "fisherrao_matrix",
    n_filters=CALVO_OLLER_N_FILTERS,
...
save_pairwise_distance_csv(
    ...
    output_path=os.path.join(
        RESULTS_DIR,
        f"motion_sqfa_calvo_oller_pairwise_n{CALVO_OLLER_N_FILTERS}.csv",
    ),
...
plot_calvo_oller_vs_fisher_rao(
    ...
    output_path=os.path.join(
        FIGURES_DIR,
        f"motion_sqfa_calvo_oller_vs_fisherrao_n{CALVO_OLLER_N_FILTERS}.pdf",
    ),
)
